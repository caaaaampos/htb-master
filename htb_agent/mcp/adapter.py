"""Adapter to convert MCP tools to HTB Agent custom tool format."""
...
def schema_to_parameters(input_schema: dict) -> dict[str, dict[str, Any]]:
    """Convert JSON Schema properties to HTB Agent parameters format.
...
def mcp_to_htb_agent_tools(mcp_manager: "MCPClientManager") -> dict[str, dict[str, Any]]:
    """Convert discovered MCP tools to HTB Agent custom tool format."""
