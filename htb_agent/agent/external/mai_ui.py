...
management while using HTB Agent's AdbTools for execution.
"""
...
from htb_agent.agent.oneflows.app_starter_workflow import AppStarter
...
async def execute_action(
    ...
    """
    Execute a MAI-UI action using HTB Agent tools.
...
async def run(
    ...
    Args:
        tools: HTB Agent Tools instance (AdbTools)
