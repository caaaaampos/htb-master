...
from htb_agent.agent.utils.chat_utils import to_chat_messages
...
# =============================================================================
# Device Factory Wrapper (wraps HTB Agent tools to match original interface)
# =============================================================================


class DeviceFactoryWrapper:
    """
    Wraps HTB Agent Tools to provide the same interface as original Open-AutoGLM's
    ...
    def __init__(self, tools, loop: asyncio.AbstractEventLoop):
        ...
        Args:
            tools: HTB Agent Tools instance
    ...
    async def type_text(self, text: str) -> None:
        ...
        1. Switch to ADB keyboard (handled by HTB Agent portal)
        2. Clear existing text
        3. Type new text
        4. Restore keyboard (handled by HTB Agent portal)
        """
        # HTB Agent's input_text with clear=True handles all this
