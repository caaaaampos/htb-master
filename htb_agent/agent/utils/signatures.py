"""Tool registry builder — single place for all standard htb_agent tools."""

import logging

from htb_agent.agent.tool_registry import ToolRegistry
from htb_agent.agent.utils.actions import (
    click,
    click_area,
    click_at,
    complete,
...
async def build_tool_registry(
    ...
    """Build a ToolRegistry with all standard htb_agent tools.
