"""
Trajectory utilities for HTB Agent agents.
...
from htb_agent.agent.trajectory.writer import make_serializable
...
class Trajectory:
    def __init__(self, goal: str = None, base_path: str = "trajectories"):
        ...
        self.goal = goal or "HTB Agent automation sequence"
