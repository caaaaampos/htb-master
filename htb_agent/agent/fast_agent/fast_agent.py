...
from htb_agent.agent.action_result import ActionResult
from htb_agent.agent.common.constants import LLM_HISTORY_LIMIT
...
from htb_agent.agent.fast_agent.events import (
    FastAgentEndEvent,
    FastAgentInputEvent,
...
from htb_agent.agent.fast_agent.xml_parser import (
    ToolResult,
    format_tool_calls,
    format_tool_results,
    parse_tool_calls,
)
from htb_agent.agent.usage import get_usage_from_response
from htb_agent.agent.utils.chat_utils import limit_history
