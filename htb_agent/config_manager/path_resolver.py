"""
Unified path resolution for HTB Agent.
...
class PathResolver:
    """
    Unified path resolver for all HTB Agent file operations.
    ...
    def get_project_root() -> Path:
        ...
        htb_agent/config_manager/path_resolver.py -> htb_agent/ (package root)
        """
