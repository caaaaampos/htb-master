"""HTB Agent TUI - Main application."""
...
from htb_agent.cli.tui.commands import match_commands, resolve_command
from htb_agent.cli.event_handler import EventHandler
from htb_agent.log_handlers import TUILogHandler, configure_logging
from htb_agent.cli.tui.settings import SettingsData, SettingsScreen
from htb_agent.cli.tui.widgets import (
    InputBar,
    CommandDropdown,
    DevicePicker,
    LogView,
...
class DroidrunTUI(App):
    ...
    async def _check_device(self, serial: str) -> None:
        ...
        try:
            ...
            picker.set_options(
                serial,
                "HTB Agent Portal is not set up on this device",
                [
                    ("setup", "Auto-install and set up HTB Agent Portal"),
    ...
    async def _run_device_setup(self, serial: str) -> None:
        ...
        try:
            ...
            if portal_version:
                ...
                from htb_agent.portal import get_latest_release_assets
    ...
    async def _execute_command(self, command: str) -> None:
        ...
        try:
            from htb_agent import DroidAgent, ResultEvent
            from htb_agent.config_manager import ConfigLoader
