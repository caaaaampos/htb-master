"""
Command-line interface for HTB Agent macro replay.
"""
...
from htb_agent.macro.replay import MacroPlayer
...
def replay(
    ...
    logger.info("🎬 HTB Agent Macro Replay")
...
def list(directory: str, debug: bool):
    ...
    try:
        ...
        console.print(table)
        logger.info(
            f"💡 Use 'htb_agent macro replay {resolved_dir}/<folder>' to replay a trajectory"
        )
