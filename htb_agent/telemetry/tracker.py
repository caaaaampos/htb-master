...
This module handles opt-in telemetry collection to help improve HTB Agent.
...
logger = logging.getLogger("htb_agent-telemetry")
htb_agent_logger = logging.getLogger("htb_agent")
...
def print_telemetry_message():
    ...
    if is_telemetry_enabled():
        ...
        htb_agent_logger.debug(TELEMETRY_DISABLED_MESSAGE)
