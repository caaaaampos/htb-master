...
Usage:
    from htb_agent.telemetry.langfuse_processor import LangfuseSpanProcessor
...
class LangfuseSpanProcessor(BaseLangfuseSpanProcessor):
    ...
    def _extract_agent_input(self) -> Optional[dict]:
        ...
        try:
            ...
            input_data["htb_agent_version"] = "v" + __version__
            ...
            if span.name == "DroidAgent.run":
                ...
                if input_data:
                    ...
                    if "vision_enabled" in input_data:
                        span._attributes["htb_agent.vision.enabled"] = input_data[
                            "vision_enabled"
                        ]
    ...
    def on_end(self, span: ReadableSpan) -> None:
        ...
        try:
            ...
            elif span.name == "htb_agent.screenshot":
    ...
    def _process_screenshot_span(self, span: ReadableSpan) -> None:
        ...
        image_b64 = attrs.get("htb_agent.screenshot.image_base64")
        mime_type = attrs.get("htb_agent.screenshot.mime_type", "image/png")
        ...
        attrs.pop("htb_agent.screenshot.image_base64", None)
        attrs.pop("htb_agent.screenshot.mime_type", None)
