...
**Location**: `htb_agent/agent/droid/droid_agent.py`

### ManagerAgent (Planner)
Creates strategic plans and breaks tasks into subgoals. Reasoning mode only.

**Location**: `htb_agent/agent/manager/manager_agent.py`
...
**Location**: `htb_agent/agent/executor/executor_agent.py`
...
**Location**: `htb_agent/agent/codeact/codeact_agent.py`
...
**Location**: `htb_agent/agent/scripter/`
