...
<a id="htb_agent.tools.tools.Tools"></a>
...
<a id="htb_agent.tools.tools.Tools.ui_action"></a>
...
```python
from htb_agent.tools import Tools
...
<a id="htb_agent.tools.tools.describe_tools"></a>
...
```python
from htb_agent.tools import AdbTools, describe_tools
...
```python
from htb_agent.tools import describe_tools
...
```python
from htb_agent.tools import AdbTools, IOSTools
...
from htb_agent.tools import AdbTools, Tools
