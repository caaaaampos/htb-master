...
htb_agent run "task" --tracing

# Enable trajectory recording
htb_agent run "task" --save-trajectory step
```
...
export phoenix_project_name=my_htb_agent_project
```
...
**Via code:**
```python
from htb_agent import DroidAgent, DroidrunConfig, TracingConfig
