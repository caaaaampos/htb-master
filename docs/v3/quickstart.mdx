---
title: 'Quickstart'
description: 'Get up and running with HTB Agent quickly and effectively'
---
...
This guide will help you get HTB Agent installed and running quickly, controlling your Android device through natural language in minutes.

### Prerequisites

Before installing HTB Agent, ensure you have:
...
htb_agent "Open the settings app and tell me the android version" --provider OpenAI --model gpt-4o
```
...
Now that you've got HTB Agent running, you can:
