...
- Ensure HTB Agent works well across different environments
...
If you have questions or concerns, please reach out on [GitHub](https://github.com/htb_agent/htb_agent) or review our privacy policy.

---

# Toggling Telemetry

HTB Agent collects <b>anonymized</b> usage data to help us understand which features are most valuable and where improvements are needed. This data is <b>never</b> used for advertising or tracking individuals, and is only used to make HTB Agent better for the community.
