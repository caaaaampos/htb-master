...
- **Python 3.10+**
- **htb_agent** framework installed (see [Droidrun Quickstart](../quickstart.mdx)).
<Warning>
...
from htb_agent import DroidAgent, AdbTools
...
- **Compatibility:** Vision models do not run correctly on apple silicon chips. Check [issue #55 (htb_agent)](https://github.com/htb_agent/htb_agent/issues/55#issuecomment-2959912711), [issue @ ollama](https://github.com/ollama/ollama/issues/10986)
