...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/htb_agent.git
   cd htb_agent
   ```
...
- Check our [Documentation](https://docs.hackthebox.com)
- Report bugs and request features through [GitHub Issues](https://github.com/htb_agent/htb_agent/issues)
